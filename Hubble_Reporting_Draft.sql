CREATE OR REPLACE TABLE `nbcu-ds-sandbox-a-001.Shunchao_Sandbox.Hubble_Report_`
AS
WITH fwlogs_r AS (
...
silver AS (
    SELECT adobe_tracking_id AS silver_Id,
        ...
        num_views_started AS Content_Start, --20311
...
SELECT DISTINCT 
    ...
    b.silver_PersonaId,
    b.silver_Program,
    date(b.silver_Date) as Adobe_Date, 
    b.Content_Start,
    a.creativeName
FROM fwm_joined a
...
where date(b.silver_Date) between "2023-04-03" and "2023-04-13" 
and b.silver_Id in ("UYaTydAICsf98MX5HXcLCM7JjeBnrZ4HlPcpeehFDAg=",
                    "sWcscTZ3D9CBW7UA6sLScdtiOUKNXu2wti8TOoqV/X8=",
                    "8NE8fUEseyDrt4pBcVuEjaJqXwN9LtySgAfRmkERuLk=",
                    "0BUUALT8/GJ9TAELJnBOg7o5/S13jpEm3lNK2MdcHqs=",
                    "6WSc2tvNHbxqi2jcKbtm0OjDvZqBA7uL8LiTtIo7Gc4=",
                    "p2mQPqBRtftJgNhtKKE3nsQDkS7XKcVCV14XYs500gE=",
                    "Ks6Gyag+mKzNAdz/18P8+xvegxY5PxB6QKxIoXCDEVI=",
                    "2f6SEPnzXxHfRs5T8fHtSvRWwUCphvbuVGf0jVtRB2Y=",
                    "utY4CAe49NYCnlYHXODFjNCYnnFNX+RHbCDIoV+8T/g=",
                    "WR//m1/rz5SGH1+QaxsB3LF5ClZesq9SK7aDlc1UzMk=")
